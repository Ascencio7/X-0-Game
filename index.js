...
function gameOver(a) {
    var gameOverAlertElement = "<b>Fin del juego </b><br><br> ¡Jugador " + span[a].dataset.player.toUpperCase() + ' ganó! <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>¡Nadie ganó!</b><br>¡Intenta de nuevo!<br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
